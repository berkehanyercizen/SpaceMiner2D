...
| Field | Value |
|-------|-------|
| **Engine Version** | Unity 6000.4.5f1 (Unity 6 — patch 4.5) |
| **Reference Docs Cover** | Unity 6.3 LTS (December 2025) |
| **Project Pinned** | 2026-05-11 |
| **Last Docs Verified** | 2026-02-13 (6.3 LTS); project on 6000.4.5f1 — see gap note |
| **LLM Knowledge Cutoff** | May 2025 |

> ⚠️ **Version Gap**: Reference docs cover 6.3 LTS. Project uses `6000.4.5f1` (Unity 6.4.5).
> APIs introduced between 6.3 and 6.4.5 are not covered by these docs.
> Run `/setup-engine refresh` or consult Unity 6.4 release notes before using new APIs.
